...
class ImageMetaData(object):
    ...
    def get_lat_lng_alt(self):
        ...
        if "GPS" in exif_data:
            ...
            gps_altitude_ref = self.get_if_exist(
                gps_data, piexif.GPSIFD.GPSAltitudeRef)
            if gps_latitude and gps_latitude_ref \
                    and gps_longitude and gps_longitude_ref 
                    and gps_altitude and gps_altitude_ref:
                gps_latitude_ref = gps_latitude_ref.decode("utf-8")
                gps_longitude_ref = gps_longitude_ref.decode("utf-8")
                gps_altitude_ref = gps_altitude_ref.decode("utf-8")
